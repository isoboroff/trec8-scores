...
my $root = "/Users/soboroff/trec/trec8-scores";
my $pool_runs_desc = "$root/runs-list";
my $full_qrels = "$root/trec8.qrels";

my $runs_table = "$root/runs_table.adhoc";
